...
<head>
    ...
    <title>SIAE 3.0 | @yield('titulo', 'Inicio')</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ url('dist/assets/img/favicon.ico') }}" />
...
<body class="layout-fixed sidebar-expand-lg bg-body-tertiary">
    ...
    <script src="{{ url('assets/back/js/adminlte.js') }}"></script>
